 ...
 * @data 2021/03/03
 */
public class NewSdkBeanConfigJava extends SdkBeanConfigJava {
    private static final String TEMPLATE_RESOURCE
            = "webase_templates/SdkBeanConfig.java";
    public static final String JAVA = "SdkBeanConfig.java";

    private File parentDir;
    private UserConfig config;

    public NewSdkBeanConfigJava(File parentDir, UserConfig config){
        super(parentDir, config);
